...
Gumps.AddHtmlLocalized(gd, 55, 24, 400, 60, 1156863, True, True)
Gumps.AddButton(gd, 400, 400, 2073, 2072, 0, 1, 0)

Gumps.AddPage(gd, 1)
Gumps.AddButton(gd, 25, 85, 4005, 4007, 0, 0, 2)
Gumps.AddHtml(gd, 60, 88, 150, 18, "Next Page", True, True)
...
Gumps.AddHtml(gd, 60, 88, 150, 18, "Previous Page", True, True)
Gumps.AddButton(gd, 25, 105, 4011, 4012, 3, 1, 0)
